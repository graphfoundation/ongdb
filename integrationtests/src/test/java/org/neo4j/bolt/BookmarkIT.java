...
/**
 * Verifies the client-visible bookmark contract: while one transaction is mid-commit
 * (appended but not yet applied), concurrent commits still return distinct, up-to-date
 * bookmarks that drivers can use for causal consistency.
 */
