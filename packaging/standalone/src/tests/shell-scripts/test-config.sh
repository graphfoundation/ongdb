...
test_expect_success "http: should read port and address from config" "
  clear_config &&
  set_config 'dbms.connector.http.address' '1.2.3.4:1234' ongdb.conf &&
  set_config 'dbms.connector.http.enabled' 'true' ongdb.conf &&
...
test_expect_success "http: should read only port from config" "
  clear_config &&
  set_config 'dbms.connector.http.address' ':1234' ongdb.conf &&
  set_config 'dbms.connector.http.enabled' 'true' ongdb.conf &&
...
test_expect_success "http: should fallback to default listening address if defined" "
  clear_config &&
  set_config 'dbms.connectors.default_listen_address' '100.200.300.400' ongdb.conf &&
  set_config 'dbms.connector.http.enabled' 'true' ongdb.conf &&
...
test_expect_success "http: should read port and address from config and prioritize non-deprecated" "
  clear_config &&
  set_config 'dbms.connector.http.address' '1.2.3.4:1234' ongdb.conf &&
  set_config 'dbms.connector.http.listen_address' 'a.b.c.d:333' ongdb.conf &&
  set_config 'dbms.connector.http.enabled' 'true' ongdb.conf &&
...
test_expect_success "https: should read port and address from config" "
  clear_config &&
  set_config 'dbms.connector.http.enabled' 'false' ongdb.conf &&
  set_config 'dbms.connector.https.address' '1.2.3.4:1234' ongdb.conf &&
  set_config 'dbms.connector.https.enabled' 'true' ongdb.conf &&
...
test_expect_success "https: should read only port from config" "
  clear_config &&
  set_config 'dbms.connector.http.enabled' 'false' ongdb.conf &&
  set_config 'dbms.connector.https.address' ':1234' ongdb.conf &&
  set_config 'dbms.connector.https.enabled' 'true' ongdb.conf &&
...
test_expect_success "https: should read port and address from config and prioritize non-deprecated" "
  ...
  set_config 'dbms.connector.http.enabled' 'false' ongdb.conf &&
  set_config 'dbms.connector.https.address' '1.2.3.4:1234' ongdb.conf &&
  set_config 'dbms.connector.https.listen_address' 'a.b.c.d:333' ongdb.conf &&
  set_config 'dbms.connector.https.enabled' 'true' ongdb.conf &&
...
test_expect_success "should write a specific message in HA mode" "
  clear_config &&
  set_config 'dbms.mode' 'HA' ongdb.conf &&
...
test_expect_success "should write active database" "
  clear_config &&
  set_config 'dbms.active_database' 'bigdata' ongdb.conf &&
