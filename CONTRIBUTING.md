# Contributing to the ONgDB Ecosystem

At [The Graph Foundation](https://www.graphfoundation.org/), we develop our software in the open at GitHub.
...
We also provide areas specifically for community contributions, in particular the [graphfoundation](https://github.com/graphfoundation) space.
...
If you simply want to get started or have a question on how to use a particular feature,
drop a line to the [mailing list](https://groups.google.com/forum/#!forum/neo4j),
ask a question in [Slack](https://neo4j.com/slack),
or tweet [@GraphFoundation](https://twitter.com/GraphFoundation) us or
reference our hashtag, [#ONgDB](https://twitter.com/hashtag/ONgDB).
...
If you want to find out more about how you can contribute, head over to our website to [get involved](https://www.graphfoundation.org/get-involved/).
