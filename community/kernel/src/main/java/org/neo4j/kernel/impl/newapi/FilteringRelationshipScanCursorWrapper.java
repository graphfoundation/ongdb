...
public class FilteringRelationshipScanCursorWrapper implements RelationshipScanCursor
{
    ...
    public FilteringRelationshipScanCursorWrapper( RelationshipScanCursor delegate,
     ...
     */
    public FilteringRelationshipScanCursorWrapper( RelationshipScanCursor delegate,
            Predicate<RelationshipScanCursor> filter, Collection<AutoCloseable> resources )
    {
