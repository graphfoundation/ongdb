...
abstract class SupportPartitionedScanTestSuite
{
    ...
    protected enum Query
    {
        ...
        RANGE_NUMBER_ARRAY( id ->
            PropertyIndexQuery.range( id, Values.of( new int[]{-999, -999} ), true,
                                          Values.of( new int[]{999, 999} ), false ) ),
        ...
        RANGE_TEMPORAL_ARRAY( id ->
            PropertyIndexQuery.range( id, Values.of( new ZonedDateTime[]{ZonedDateTime.ofInstant( Instant.EPOCH, ZoneOffset.UTC ),
                                                                         ZonedDateTime.now().minusWeeks( 1 )} ), false,
                                          Values.of( new ZonedDateTime[]{ZonedDateTime.now(),
                                                                         ZonedDateTime.now().plusWeeks( 1 )} ), true ) ),
        RANGE_BOOLEAN( id -> PropertyIndexQuery.range( id, Values.of( false ), true, Values.of( true ), true ) ),
        RANGE_BOOLEAN_ARRAY( id ->
