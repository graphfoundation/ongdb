...
public class DurationUniqueSchemaIndexPopulatorTest extends NativeUniqueSchemaIndexPopulatorTest<DurationSchemaKey,NativeSchemaValue>
{
    @Override
    NativeSchemaIndexPopulator<DurationSchemaKey,NativeSchemaValue> createPopulator( IndexSamplingConfig samplingConfig )
    {
