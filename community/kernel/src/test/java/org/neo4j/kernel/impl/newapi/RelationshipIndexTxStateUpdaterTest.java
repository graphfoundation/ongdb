...
public class RelationshipIndexTxStateUpdaterTest extends IndexTxStateUpdaterTestBase
{
    ...
    private final IndexDescriptor indexOn_1_new = TestIndexDescriptorFactory.forRelType( TYPE_ID, PROP_ID_1, NEW_PROP_ID );
    private final IndexDescriptor indexOn_2_3 = TestIndexDescriptorFactory.forRelType( TYPE_ID, PROP_ID_2, PROP_ID_3 );
    private final List<IndexDescriptor> indexes = Arrays.asList( indexOn_1, indexOn_new, indexOn_2, indexOn_1_new, indexOn_2_3 );
    ...
    {
        // WHEN
        indexTxUpdater.onPropertyAdd( relationship, propertyCursor, TYPE_ID, UN_INDEXED_PROP_ID, PROPS, Values.of( "whAt" ) );
        indexTxUpdater.onPropertyRemove( relationship, propertyCursor, TYPE_ID, UN_INDEXED_PROP_ID, PROPS, Values.of( "whAt" ) );
        indexTxUpdater.onPropertyChange( relationship, propertyCursor, TYPE_ID, UN_INDEXED_PROP_ID, PROPS, Values.of( "whAt" ), Values.of( "whAt2" ) );
    ...
    {
        // WHEN
        indexTxUpdater.onPropertyAdd( relationship, propertyCursor, UN_INDEXED_TYPE_ID, PROP_ID_1, PROPS, Values.of( "whAt" ) );
        indexTxUpdater.onPropertyRemove( relationship, propertyCursor, UN_INDEXED_TYPE_ID, PROP_ID_1, PROPS, Values.of( "whAt" ) );
        indexTxUpdater.onPropertyChange( relationship, propertyCursor, UN_INDEXED_TYPE_ID, PROP_ID_1, PROPS, Values.of( "whAt" ), Values.of( "whAt2" ) );
    ...
    {
        // WHEN
        indexTxUpdater.onPropertyChange( relationship, propertyCursor, TYPE_ID, PROP_ID_2, PROPS, Values.of( "hi2" ), Values.of( "new2" ) );
