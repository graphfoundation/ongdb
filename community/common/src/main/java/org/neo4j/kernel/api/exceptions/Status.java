 ...
 * guaranteed. Instead, the automatically generated documentation derived from this class and available in the ONgDB
    ...
    */
    ...
    enum Transaction implements Status
    {
        ...
        InvalidBookmark( ClientError,
                ...
                "previously generated by ONgDB. Maybe you have generated your own bookmark, " +
                "or modified a bookmark since it was generated by ONgDB." ),
    ...
    enum General implements Status
    {
        ...
        TransactionOutOfMemoryError( ClientError,
                ...
                "transaction can be configured with 'dbms.memory.transaction.max_size' in the ongdb configuration " +
                "(normally in 'conf/ongdb.conf' or, if you are using ONgDB Desktop, found through the user interface)." ),
        ...
        TransactionMemoryLimit( TransientError,
                "There is not enough memory to perform the current task. Please try increasing " +
                        "'dbms.memory.off_heap.max_size' in the ongdb configuration (normally in 'conf/ongdb.conf' or, if " +
                        "you are using ONgDB Desktop, found through the user interface), and then restart the database." ),
        OutOfMemoryError( TransientError,
                "There is not enough memory to perform the current task. Please try increasing " +
                "'dbms.memory.heap.max_size' in the ongdb configuration (normally in 'conf/ongdb.conf' or, if " +
                "you are using ONgDB Desktop, found through the user interface) or if you are running an embedded " +
        ...
        StackOverFlowError( TransientError,
                ...
                "ONgDB Desktop, found through the user interface) or if you are running an embedded installation " +
