...
class IndexPopulationJobMonitoringTest
{
    ...
    void testPopulationOfSingleIndex()
    {
        ...
        when( scan.getProgress() ).thenReturn(
    ...
    private static void addIndex( IndexPopulationJob job, String indexName )
    {
        ...
        var indexProxyInfo = new ValueIndexProxyStrategy( indexDescriptor, mock( IndexStatisticsStore.class ), SchemaTestUtil.SIMPLE_NAME_LOOKUP );
