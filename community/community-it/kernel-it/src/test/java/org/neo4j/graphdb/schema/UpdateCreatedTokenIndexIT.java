...
class UpdateCreatedTokenIndexIT
{
    ...
    {
        shouldHandleIndexCreateConcurentlyWithOperation( ( tx, nodeId ) -> tx.getNodeById( nodeId ).removeLabel( LABEL_ONE ) );
    }

    @RepeatedTest( 5 )
    void shouldHandleDeleteNodeConcurrentlyWithIndexCreate() throws Throwable
    {
        shouldHandleIndexCreateConcurentlyWithOperation( ( tx, nodeId ) -> tx.getNodeById( nodeId ).delete() );
    }
