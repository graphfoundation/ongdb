...
abstract class IndexTransactionStateWithApplyChangesTestBase extends KernelAPIWriteTestBase<WriteTestSupport>
{
    ...
    void assertEntityAndValue( Set<EntityWithProps> expected, KernelTransaction tx, boolean needsValues, Object anotherValueFoundByQuery,
            Object anotherValueFoundByQuery2, EntityValueIndexCursor entities ) throws Exception
    {
        ...
        else
        {
            ...
            ImmutableSet<Long> expectedIds = expected.stream().map( entity -> entity.entityId ).collect( Collectors2.toImmutableSet() );
    ...
    abstract EntityWithProps setProperties( KernelTransaction tx, long entity, Object value, Object value2 ) throws Exception;
     ...
     */
    abstract void assertEntityAndValueForScan( Set<EntityWithProps> expected, KernelTransaction tx, IndexDescriptor index, boolean needsValues,
    ...
    static class EntityWithProps
    {
        final long entityId;
        final Value propValue1;
        final Value propValue2;

        EntityWithProps( long entityId, Value propValue1, Value propValue2 )
        {
        ...
        public boolean equals( Object o )
        {
            ...
            EntityWithProps that = (EntityWithProps) o;
            return entityId == that.entityId && Objects.equals( propValue1, that.propValue1 ) && Objects.equals( propValue2, that.propValue2 );
        }

        @Override
        public int hashCode()
        {
            return Objects.hash( entityId, propValue1, propValue2 );
        }
    }
}
