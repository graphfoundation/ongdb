...
public class ImportToolTest
{
    ...
    public void shouldPrintReferenceLinkOnDataImportErrors()
    {
        ...
        shouldPrintReferenceLinkAsPartOfErrorMessage( nodeIds(),
                ...
                "format in the manual:  https://docs.graphfoundation.org/operations-manual/" +
                docsVersion +
        ...
        shouldPrintReferenceLinkAsPartOfErrorMessage( Arrays.asList( "1", "1" ),
                ...
                "about how to use id spaces in the manual: https://docs.graphfoundation.org/operations-manual/" +
                docsVersion +
