...
import org.neo4j.cypher.internal.v3_6.expressions.{Expression, LogicalProperty, Variable}
import org.neo4j.cypher.internal.v3_6.util.symbols._
import org.neo4j.cypher.internal.v3_6.util.{ASTNode, InputPosition}
import org.neo4j.cypher.internal.v3_6.ast.semantics.{SemanticAnalysisTooling, SemanticCheckable, SemanticExpressionCheck}
