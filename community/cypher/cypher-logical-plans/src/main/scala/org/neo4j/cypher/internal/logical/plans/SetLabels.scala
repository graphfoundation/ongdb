 ...
 */
case class SetLabels(override val source: LogicalPlan, idName: String, labelNames: Seq[LabelName])(implicit idGen: IdGen) extends LogicalUnaryPlan(idGen) with UpdatingPlan {
