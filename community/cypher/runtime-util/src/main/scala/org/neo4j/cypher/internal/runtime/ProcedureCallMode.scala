...
sealed trait ProcedureCallMode {
  ...
  def callProcedure(ctx: QueryContext, id: Int, args: Seq[AnyValue], context: ProcedureCallContext): Iterator[Array[AnyValue]]
...
case class LazyReadOnlyCallMode(allowed: Array[String]) extends ProcedureCallMode {
  ...
  override def callProcedure(ctx: QueryContext, id: Int, args: Seq[AnyValue], context: ProcedureCallContext): Iterator[Array[AnyValue]] =
