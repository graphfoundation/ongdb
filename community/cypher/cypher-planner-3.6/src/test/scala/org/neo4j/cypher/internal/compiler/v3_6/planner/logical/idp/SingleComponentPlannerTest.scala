...
import org.neo4j.cypher.internal.ir.v3_6.{PatternRelationship, QueryGraph, SimplePatternLength}
...
import org.neo4j.cypher.internal.v3_6.expressions.{PropertyKeyName, SemanticDirection}
