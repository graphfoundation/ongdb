...
class CypherPreParserTest extends CypherFunSuite with TableDrivenPropertyChecks {
  ...
  val queries: TableFor2[String, PreParserResult] = Table(
    ...
    ("EXPLAIN CYPHER 4.1 WITH YALL", new PreParserResult(List.of[PreParserOption](mode("EXPLAIN"), version("4.1")), (1, 20, 19))),
    ("EXPLAIN CYPHER 4.1 $WITH YALL", new PreParserResult(List.of[PreParserOption](mode("EXPLAIN"), version("4.1")), (1, 20, 19))),
    ("CYPHER planner=cost RETURN", new PreParserResult(List.of[PreParserOption](opt("planner", "cost")), (1, 21, 20))),
    ("CYPHER 4.1 planner=cost RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "cost")), (1, 25, 24))),
    ("CYPHER 4.1 planner = idp RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "idp")), (1, 26, 25))),
    ("CYPHER planner =dp RETURN", new PreParserResult(List.of[PreParserOption](opt("planner", "dp")), (1, 20, 19))),
    ("CYPHER runtime=interpreted RETURN", new PreParserResult(List.of[PreParserOption](opt("runtime", "interpreted")), (1, 28, 27))),
    ("CYPHER 4.1 planner=cost runtime=interpreted RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "cost"), opt("runtime", "interpreted")), (1, 45, 44))),
    ("CYPHER 4.1 planner=dp runtime=interpreted RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "dp"), opt("runtime", "interpreted")), (1, 43, 42))),
    ("CYPHER 4.1 planner=idp runtime=interpreted RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "idp"), opt("runtime", "interpreted")), (1, 44, 43))),
    ("CYPHER 4.1 planner=idp planner=dp runtime=interpreted RETURN", new PreParserResult(List.of[PreParserOption](version("4.1"), opt("planner", "idp"), opt("planner", "dp"), opt("runtime", "interpreted")), (1, 55, 54))),
    ("CYPHER updateStrategy=eager RETURN", new PreParserResult(List.of[PreParserOption](opt("updateStrategy", "eager")), (1, 29, 28))),
    ("CYPHER runtime=slotted RETURN", new PreParserResult(List.of[PreParserOption](opt("runtime", "slotted")), (1, 24, 23))),
    ("CYPHER expressionEngine=interpreted RETURN", new PreParserResult(List.of[PreParserOption](opt("expressionEngine", "interpreted")), (1, 37, 36))),
    ("CYPHER expressionEngine=compiled RETURN", new PreParserResult(List.of[PreParserOption](opt("expressionEngine", "compiled")), (1, 34, 33))),
    ...
    (" EXPLAIN CYPHER 4.1 MATCH (n) RETURN", new PreParserResult(List.of[PreParserOption](mode("EXPLAIN"), version("4.1")), (1, 21, 20))),
    ...
    (" EXPLAIN/* 2 */ // \n  query",
      new PreParserResult(List.of[PreParserOption](mode("EXPLAIN")), (2, 3, 22))),
    ("CYPHER // \n a // \n = b query",
      new PreParserResult(List.of[PreParserOption](opt("a", "b")), (3, 6, 23))),
    (" /* 1 */ EXPLAIN CYPHER\n planner /* 2 */ // \n =  /** 3 */ // \n cost MATCH /* 4 */ s ",
  ...
  private def parse(queryText: String): PreParserResult = {
    new CypherPreParser(new Neo4jASTExceptionFactory(Neo4jCypherExceptionFactory(queryText, None)), new PreParserCharStream(queryText)).parse()
  }
