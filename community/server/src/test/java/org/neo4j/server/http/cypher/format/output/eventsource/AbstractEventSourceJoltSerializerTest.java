...
public abstract class AbstractEventSourceJoltSerializerTest
{
    ...
    protected static void writeStatementStart( LineDelimitedEventSourceJoltSerializer serializer, List<ResultDataContent> resultDataContents,
            String... columns )
    {
    ...
    protected static void writeRecord( LineDelimitedEventSourceJoltSerializer serializer, Map<String,?> row, String... columns )
    {
    ...
    protected static void writeStatementEnd( LineDelimitedEventSourceJoltSerializer serializer, ExecutionPlanDescription planDescription,
    ...
    protected static Path mockPath( Map<String,Object> startNodeProperties, Map<String,Object> relationshipProperties, Map<String,Object> endNodeProperties )
    {
    ...
    protected static ExecutionPlanDescription mockedPlanDescription( String operatorType, Set<String> identifiers, Map<String,Object> args,
