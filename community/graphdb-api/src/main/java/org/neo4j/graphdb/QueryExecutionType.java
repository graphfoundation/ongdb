 ...
 * <li>execution with the <a href="https://docs.graphfoundation.org/developer-manual/current/cypher/execution-plans/">{@code PROFILE}</a> directive,
 * and</li>
 * <li>execution with the <a href="https://docs.graphfoundation.org/developer-manual/current/cypher/execution-plans/">{@code EXPLAIN}</a>
 * directive.</li>
 * </ul>
...
public final class QueryExecutionType
{
     ...
     * <a href="https://docs.graphfoundation.org/developer-manual/current/cypher/execution-plans/">{@code PROFILE}</a> directive.
     *
     ...
     * <a href="https://docs.graphfoundation.org/developer-manual/current/cypher/execution-plans/">{@code EXPLAIN} or {@code PROFILE} directives</a>.
     *
     ...
     * <a href="https://docs.graphfoundation.org/developer-manual/current/cypher/execution-plans/">{@code EXPLAIN} directive</a>.
     *
