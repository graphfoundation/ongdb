...
public class GraphDatabaseSettings implements SettingsDeclaration
{
    ...
    public static final Setting<Path> ongdb_home = newBuilder( "dbms.directories.ongdb_home", PATH, Path.of( "" ).toAbsolutePath() )
    ...
    @Description( "Use server side routing by default for ongdb:// protocol connections" )
    ...
    @Description( "The profiling frequency for the page cache. " +
            ...
            "This feature is available in ONgDB Enterprise Edition." )
