...
public class CypherRESTBuiltInProceduresInteractionIT extends BuiltInProceduresInteractionTestBase<RESTSubject>
{
    @Rule
    public SuppressOutput suppressOutput = suppressAll();

    public CypherRESTBuiltInProceduresInteractionIT()
    {
        super();
