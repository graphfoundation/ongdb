...
public class V340 extends BaseRecordFormats {
  ...
  public static final String TITLE = io.github.onograph.TokenConstants.HIGH_LIMIT_V3_4_0;

  static {
    DST_VX = StoreVersion.HIGH_LIMIT_V3_4_0.versionString();
    RCD_FMXS = new V340();
  }

  protected V340() {
    super(DST_VX, StoreVersion.HIGH_LIMIT_V3_4_0.introductionVersion(), 5,
