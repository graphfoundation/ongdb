...
public class NodeHighLimitRecordFormat extends AbstractHighLimitRecordFormat<NodeRecord> {


  static final int FFR_TOT = 15;


  static final int RC_TOT = 16;
  ...
  public NodeHighLimitRecordFormat() {
    this(16);
  }

  public NodeHighLimitRecordFormat(int rLeng) {
  ...
  private static void _refirenreForNoPa(boolean isBeingUsed, boolean isDnse, NodeRecord _nodeRecord,
    ...
    _nodeRecord.initialize(isBeingUsed, longFromIntAndMod(nxt, _lgMp), isDnse,
        longFromIntAndMod(nxtRelIdx, _lgMr), _lgLbl);
  }
  ...
  private static void _wrfrerdForNoPa(NodeRecord _nodeRecord, PageCursor _pageCursor) {
    ...
    short _mpShort = nxt == NUL ? 0 : (short) ((int) ((nxt & 64424509440L) >> 28));

    short mdrSrt = (short) (_mrShort | _mpShort);
