...
public class V310 extends BaseRecordFormats {
  ...
  public static final String TITLE = io.github.onograph.TokenConstants.HIGH_LIMIT_V3_1_0;


  static final int STD_LIMT_BXS_PER_UID = 50;

  static {
    DST_VX = StoreVersion.HIGH_LIMIT_V3_1_0.versionString();
    RCD_FMXS = new V310();
  }

  public V310() {
    super(DST_VX, StoreVersion.HIGH_LIMIT_V3_1_0.introductionVersion(), 3,
  ...
  @Override
  public String name() {
    return io.github.onograph.TokenConstants.HIGH_LIMIT_V3_1_0;
  }
