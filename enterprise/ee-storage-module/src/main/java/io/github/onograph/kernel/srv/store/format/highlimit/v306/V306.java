...
public class V306 extends BaseRecordFormats {
  ...
  public static final String TITLE = io.github.onograph.TokenConstants.HIGH_LIMIT_V3_0_6;


  static final int STD_LIMT_BXS_PER_UID = 50;

  static {
    DST_VX = StoreVersion.HIGH_LIMIT_V3_0_6.versionString();
    RCD_FMXS = new V306();
  }

  public V306() {
    super(DST_VX, StoreVersion.HIGH_LIMIT_V3_0_6.introductionVersion(), 2,
