...
class RelationshipRecordFormat extends AbstractHighLimitRecordFormat<RelationshipRecord> {
  ...
  private static void _refirenreForRePa(long hdrLng, boolean isBeingUsed, PageCursor _pageCursor,
    ...
    _relationshipRecord.initialize(isBeingUsed,
        AbstractHighLimitRecordFormat.longFromIntAndMod(nxt, _lgMpn),
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgFn, _lgMnf),
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgNs, _lgMns), tNme,
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgRpf, _lgMrpf),
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgRnf, _lgMrnf),
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgRps, _lgMrps),
        AbstractHighLimitRecordFormat.longFromIntAndMod(_lgRns, _lgMrns), has(hdrLng, 8),
        has(hdrLng, 16));
  }
  ...
  private static void _wrfrerdForRePa(PageCursor _pageCursor,
    ...
    short mdrSrt =
        (short) ((int) ((long) _mnfShort | _lgMns | _lgMrpf | _lgMrnf | _lgMrps | _lgMrns
            | _lgMpn));
  ...
  protected boolean isCauefdrrsForRE(int rLeng, RelationshipRecord _relationshipRecord) {
    return _isRobgegffre(rLeng) && (_relationshipRecord.getFirstNode() & -8589934592L) == 0L &&
