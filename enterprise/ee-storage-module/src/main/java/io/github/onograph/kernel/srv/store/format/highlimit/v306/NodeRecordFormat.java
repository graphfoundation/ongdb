...
class NodeRecordFormat extends AbstractHighLimitRecordFormat<NodeRecord> {
  ...
  private static void _refirenreForNoPa(boolean isBeingUsed, boolean isDnse, NodeRecord _nodeRecord,
    ...
    _nodeRecord.initialize(isBeingUsed, AbstractHighLimitRecordFormat.longFromIntAndMod(nxt, _lgMp),
        isDnse,
        AbstractHighLimitRecordFormat.longFromIntAndMod(nxtRelIdx, _lgMr), _lgLbl);
  }
