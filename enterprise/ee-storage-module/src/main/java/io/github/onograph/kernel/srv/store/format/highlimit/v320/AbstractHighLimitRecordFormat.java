...
abstract class AbstractHighLimitRecordFormat<RECORD extends AbstractBaseRecord> extends
  ...
  private static String _ilasoyrrmgString(long sId) {
    return io.github.onograph.I18N.format(
        "io.github.onograph.kernel.srv.store.format.highlimit.v320.AbstractHighLimitRecordFormat.ilasoyrrmgString",
        sId);
  }
  ...
  protected abstract void doreieaForREPa(int _iVar, boolean _isVa, long _lgVa,
  ...
  protected abstract boolean isCauefdrrsForRE(int _iVa, RECORD _rcrVa);
  ...
  protected void makausForPaRE(PageCursor _pageCursor, int rLeng, RECORD _rcrRcr, int rpSize)
    ...
    if (_rcrRcr.hasSecondaryUnitId()) {
      ...
      if (!_pageCursor.next(_lgRsfip)) {
        ...
        throw new UnderlyingStorageException("*** Error: e4b04dda-2901-4b75-85fb-9ad01916dcae");
      }
        ...
        if (!_isUrf) {
          ...
          if (mdstr.failOnNonFirstUnit()) {
            _cpPageCursor.setCursorException(io.github.onograph.I18N.format(
                "io.github.onograph.kernel.srv.store.format.highlimit.v320.AbstractHighLimitRecordFormat.setCursorException"));
          }
