...
class NodeRecordFormat extends AbstractHighLimitRecordFormat<NodeRecord> {
  ...
  private static void _refirenreForNoPa(boolean isBeingUsed, boolean isDnse, NodeRecord _nodeRecord,
    ...
    long _lgHl = _pageCursor.getByte() & 255;

    long _lgLbl = _lgLl | _lgHl << 32;
    _nodeRecord.initialize(isBeingUsed, longFromIntAndMod(nxt, _lgMp), isDnse,
        longFromIntAndMod(nxtRelIdx, _lgRm), _lgLbl);
  }
