...
public class RelationshipHighLimitRecordFormat extends
    AbstractHighLimitRecordFormat<RelationshipRecord> {


  public static final int INCS_C1_FLW_FLW_BX = 32;


  public static final int INCS_C2_FLW_FLW_BX = 64;


  public static final int PROP_B_IDNT = 128;
  ...
  public RelationshipHighLimitRecordFormat() {
    this(32);
  }

  public RelationshipHighLimitRecordFormat(int rLeng) {
  ...
  private static void _refirenreForRePa(long hdrLng, boolean isBeingUsed, PageCursor _pageCursor,
    ...
    long _lgFn = (long) _pageCursor.getInt() & 4294967295L;

    long _lgMnf = (mdrSrt & 1L) << 32;

    long _lgNs = (long) _pageCursor.getInt() & 4294967295L;

    long _lgMns = (mdrSrt & 2L) << 31;

    long _lgRpf = (long) _pageCursor.getInt() & 4294967295L;

    long _lgMrpf = (mdrSrt & 4L) << 30;

    long _lgRnf = (long) _pageCursor.getInt() & 4294967295L;
    ...
    _relationshipRecord.initialize(isBeingUsed, BaseRecordFormat.longFromIntAndMod(nxt, _lgMpn),
        BaseRecordFormat.longFromIntAndMod(_lgFn, _lgMnf),
        BaseRecordFormat.longFromIntAndMod(_lgNs, _lgMns), tNme,
        BaseRecordFormat.longFromIntAndMod(_lgRpf, _lgMrpf),
        BaseRecordFormat.longFromIntAndMod(_lgRnf, _lgMrnf),
  ...
  private static void _wrfrerdForRePa(PageCursor _pageCursor,
    ...
    short _fnmShort = (short) ((int) ((_lgNf & 4294967296L) >> 32));
    ...
    long _lgRnf = _relationshipRecord.getFirstNextRel();

    long _lgMrnf = _lgRnf == NUL ? 0L : (_lgRnf & 4294967296L) >> 29;
    ...
    long _lgMrns = _lgRns == NUL ? 0L : (_lgRns & 4294967296L) >> 27;

    long nxt = _relationshipRecord.getNextProp();

    long _lgNpm = nxt == NUL ? 0L : (nxt & 12884901888L) >> 26;

    short mdrSrt =
        (short) ((int) ((long) _fnmShort | _lgMns | _lgMrpf | _lgMrnf | _lgMrps | _lgMrns
            | _lgNpm));
    _pageCursor.putByte((byte) mdrSrt);
    _pageCursor.putInt((int) _lgNf);
    _pageCursor.putInt((int) _lgNs);
    _pageCursor.putInt((int) _lgRpf);
    _pageCursor.putInt((int) _lgRnf);
