...
import io.github.onograph.kernel.srv.store.format.highlimit.AbstractHighLimitRecordFormat;
...
public class RelationshipGroupRecordFormat extends
  ...
  public static final int INCS_FLW_BX = 64;


  public static final int INCS_IN_BX = 16;


  public static final int INCS_LOO_BX = 32;


  public static final int INCS_OUT_BX = 8;
  ...
  private static void _refirenmeForRePa(boolean isBeingUsed, PageCursor _pageCursor,
    ...
    long _lgFilb = (long) _pageCursor.getInt() & 4294967295L;
    ...
    _relationshipGroupRecord.initialize(isBeingUsed, tNme,
        BaseRecordFormat.longFromIntAndMod(_lgBlof, _lgFom),
        BaseRecordFormat.longFromIntAndMod(_lgFilb, _lgMif),
  ...
  private static void _wrfrerdForRePa(PageCursor _pageCursor,
    ...
    long _lgOnm = _relationshipGroupRecord.getOwningNode() == NUL ? 0L
        : (_relationshipGroupRecord.getOwningNode() & 4294967296L) >> 28;
    _pageCursor.putByte((byte) ((int) (mxtMatIdx | _lgMof | _lgMif | _lgMlf | _lgOnm)));
