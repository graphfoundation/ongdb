...
class GdbTransactionLogAdapterTest {

  @Test
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_GENERIC, (new GdbTransactionLogAdapter()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new GdbTransactionLogAdapter("Mprnm", _metricRegistryManager,
  ...
  void testConstructor3() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new GdbTransactionLogAdapter("", _metricRegistryManager, new DefaultTracer())).getGrp());
  }
  ...
  void testStart() {
    ...
    (new GdbTransactionLogAdapter("Mprnm", _metricRegistryManager, new DefaultTracer())).start();
  }
  ...
  void testStop() {
    ...
    (new GdbTransactionLogAdapter("Mprnm", _metricRegistryManager, new DefaultTracer())).stop();
  }
}
