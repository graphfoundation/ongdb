...
class BoltAdapterTest {
  ...
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_GENERIC, (new BoltAdapter()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new BoltAdapter("Mprnm", _metricRegistryManager, new Monitors())).getGrp());
  }
  ...
  void testConstructor3() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new BoltAdapter("", _metricRegistryManager, new Monitors())).getGrp());
  }
  ...
  void testStart() {
    ...
    (new BoltAdapter("Mprnm", _metricRegistryManager, new Monitors())).start();
  }
  ...
  void testStop() {
    ...
    (new BoltAdapter("Mprnm", _metricRegistryManager, new Monitors())).stop();
  }
}
