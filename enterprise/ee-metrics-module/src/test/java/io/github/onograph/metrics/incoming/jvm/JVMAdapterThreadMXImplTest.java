...
class JVMAdapterThreadMXImplTest {

  @Test
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_JVM, (new JVMAdapterThreadMXImpl()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_JVM,
        (new JVMAdapterThreadMXImpl("Mprnm",
