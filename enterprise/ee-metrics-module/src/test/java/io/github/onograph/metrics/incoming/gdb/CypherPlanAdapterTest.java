...
class CypherPlanAdapterTest {

  @Test
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_GENERIC, (new CypherPlanAdapter()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new CypherPlanAdapter("Mprnm", _metricRegistryManager, new Monitors())).getGrp());
  }
  ...
  void testConstructor3() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new CypherPlanAdapter("", _metricRegistryManager, new Monitors())).getGrp());
  }
  ...
  void testStart() {
    ...
    (new CypherPlanAdapter("Mprnm", _metricRegistryManager, new Monitors())).start();
  }
  ...
  void testStop() {
    ...
    (new CypherPlanAdapter("Mprnm", _metricRegistryManager, new Monitors())).stop();
  }
}
