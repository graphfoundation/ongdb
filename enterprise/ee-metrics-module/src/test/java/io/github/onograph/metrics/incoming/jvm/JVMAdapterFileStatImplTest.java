...
class JVMAdapterFileStatImplTest {

  @Test
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_JVM, (new JVMAdapterFileStatImpl()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_JVM,
        (new JVMAdapterFileStatImpl("Mprnm",
