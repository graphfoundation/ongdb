...
class GdbActionsAdapterTest {

  @Test
  void testConstructor() {
    assertEquals(EnterpriseMetricsType.EMT_GENERIC, (new GdbActionsAdapter()).getGrp());
  }
  ...
  void testConstructor2() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new GdbActionsAdapter("Mprnm", _metricRegistryManager,
            new DatabaseOperationCounts.Counter())).getGrp());
  }
  ...
  void testConstructor3() {
    ...
    assertEquals(EnterpriseMetricsType.EMT_GENERIC,
        (new GdbActionsAdapter("", _metricRegistryManager,
            new DatabaseOperationCounts.Counter())).getGrp());
  }
  ...
  void testStart() {
    ...
    (new GdbActionsAdapter("Mprnm", _metricRegistryManager,
        new DatabaseOperationCounts.Counter())).start();
  }
  ...
  void testStop() {
    ...
    (new GdbActionsAdapter("Mprnm", _metricRegistryManager,
        new DatabaseOperationCounts.Counter())).stop();
  }
}
