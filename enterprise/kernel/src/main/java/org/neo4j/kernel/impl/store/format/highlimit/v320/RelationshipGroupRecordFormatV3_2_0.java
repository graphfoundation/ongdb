 ...
 * => 24B
 */
class RelationshipGroupRecordFormatV3_2_0 extends BaseHighLimitRecordFormatV3_2_0<RelationshipGroupRecord>
{
    ...
    RelationshipGroupRecordFormatV3_2_0()
    {
        this( RECORD_SIZE );
    }

    RelationshipGroupRecordFormatV3_2_0( int recordSize )
    {
        super( fixedRecordSize( recordSize ), 0, HighLimitFormatSettingsV3_2_0.RELATIONSHIP_GROUP_MAXIMUM_ID_BITS );
    }
