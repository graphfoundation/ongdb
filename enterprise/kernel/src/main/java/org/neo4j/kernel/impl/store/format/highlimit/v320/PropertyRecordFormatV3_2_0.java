 ...
 *
 * </pre>
 * Unlike other high limit records {@link BaseHighLimitRecordFormatV3_2_0} fixed reference marker in property record format header is not inverted: 1 - fixed
...
class PropertyRecordFormatV3_2_0 extends BaseOneByteHeaderRecordFormat<PropertyRecord>
{
    ...
    protected PropertyRecordFormatV3_2_0()
    {
        super( fixedRecordSize( RECORD_SIZE ), 0, IN_USE_BIT,
               HighLimitFormatSettingsV3_2_0.PROPERTY_MAXIMUM_ID_BITS );
    }
