...
public final class TransactionId extends Id
{

    public static final String TRANSACTION_ID_SEPARATOR = "-transaction-";

    public TransactionId( String database, long kernelTransactionId ) throws InvalidArgumentsException
    {
        super( database, kernelTransactionId, TRANSACTION_ID_SEPARATOR );
    }

    public TransactionId( String external ) throws InvalidArgumentsException
    {
