...
import static org.neo4j.kernel.impl.store.format.highlimit.v340.BaseHighLimitRecordFormatV3_4_0.HEADER_BIT_FIXED_REFERENCE;
import static org.neo4j.kernel.impl.store.format.highlimit.v340.BaseHighLimitRecordFormatV3_4_0.HEADER_BYTE;
import static org.neo4j.kernel.impl.store.format.highlimit.v340.BaseHighLimitRecordFormatV3_4_0.NULL;
 ...
 *
 * </pre>
 * Unlike other high limit records {@link BaseHighLimitRecordFormatV3_4_0} fixed reference marker in property record format header is not inverted: 1 - fixed
...
class PropertyRecordFormatV3_4_0 extends BaseOneByteHeaderRecordFormat<PropertyRecord>
{
    ...
    protected PropertyRecordFormatV3_4_0()
    {
        super( fixedRecordSize( RECORD_SIZE ), 0, IN_USE_BIT,
               HighLimitFormatSettingsV3_4_0.PROPERTY_MAXIMUM_ID_BITS );
    }
