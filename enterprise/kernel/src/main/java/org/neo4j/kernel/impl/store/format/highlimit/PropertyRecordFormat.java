 ...
 *
 * </pre>
 * Unlike other high limit records {@link BaseHighLimitRecordFormat} fixed reference marker in property record format header is not inverted: 1 - fixed
...
class PropertyRecordFormat extends BaseOneByteHeaderRecordFormat<PropertyRecord>
{
    ...
    protected PropertyRecordFormat()
    {
        super( fixedRecordSize( RECORD_SIZE ), 0, IN_USE_BIT,
               HighLimitFormatSettings.PROPERTY_MAXIMUM_ID_BITS );
    }
