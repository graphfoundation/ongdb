...
public class CheckPointThresholdPolicyVolumetricImpl implements CheckPointThresholdPolicy {
  ...
  public CheckPointThreshold createThreshold(Config _config, SystemNanoClock _systemNanoClock,
    ...
    return new CheckPointThresholdVolumetricPolicy(_logPruning);
  }

  @Override
  public String getName() {
    return io.github.onograph.TokenConstants.VOLUMETRIC;
  }
}
