...
import org.neo4j.fabric.GraphIdProc;
...
import org.neo4j.fabric.new42.TransactionMonitorScheduler;
...
public abstract class FabricServicesBootstrap
{
    ...
    public void registerProcedures( GlobalProcedures globalProcedures ) throws KernelException
    {
        ...
        {
            globalProcedures.register( new GraphIdProc( this.fabricConfig ) );
        }
    }
    ...
    public static class Enterprise extends FabricServicesBootstrap
    {

        public Enterprise( LifeSupport lifeSupport, Dependencies dependencies, LogService logService )
        {
