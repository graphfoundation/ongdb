...
public interface CompositeTransaction
{
    ...
    /**
     * Starts and registers a transaction that is so far known to do only reads. Such transaction can be later upgraded to a writing one using {@link
     * #upgradeToWritingTransaction(SingleDbTransaction)}
     */
    ...
    /**
     * Starts and registers a transaction that will do only reads. Such transaction cannot be later upgraded to a writing one using {@link
     * #upgradeToWritingTransaction(SingleDbTransaction)}
     */
