...
public abstract class FabricDatabaseManager
{
    ...
    public static class Community extends FabricDatabaseManager
    {
        ...
        {
            // a "Fabric" db with special capabilities cannot exist in CE
        }
    ...
    public static class Enterprise extends FabricDatabaseManager
    {

        public Enterprise( DatabaseManager<DatabaseContext> databaseManager )
        {
            super( databaseManager );
        }
        ...
        {
            // a "Fabric" db with special capabilities cannot exist in CE
            // We will see about that! TODO: Implement
        }
