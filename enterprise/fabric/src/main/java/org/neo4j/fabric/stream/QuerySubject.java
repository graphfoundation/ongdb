...
public interface QuerySubject extends QuerySubscriber, Publisher<Record>
{
    ...
    class BasicQuerySubject extends RecordQuerySubscriber implements QuerySubject
    {
         ...
         * Writes the field.
         * <p>
         * This method is guaranteed to be called exactly <tt>numberOfFields</tt> times with increasing offsets in [0, <tt>numberOfFields</tt> -1], where
         * <tt>numberOfFields</tt> is the argument provided in {@link #onResult(int)} ()}
         *
