...
/**
 * Transaction monitor that check transactions with a configured timeout for expiration. In case if transaction timed out it will be terminated.
 */
public abstract class TransactionMonitor implements Runnable
{
    ...
    public interface MonitoredTransaction
    {
         ...
         * @return {@code true} if the underlying transaction was marked for termination, {@code false} otherwise (when this handle represents an old
         * transaction that has been closed).
         */
