...
/**
 * A collection of methods that allow overriding default behaviour to make some aspects of Fabric testable. An override is injected using thread local values,
 * in order to avoid interference between tests executed in parallel.
 */
