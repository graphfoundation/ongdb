...
public class EnterpriseMultiDatabaseManager extends MultiDatabaseManager<StandaloneDatabaseContext>
{
    ...
    {
        ModularDatabaseCreationContext databaseCreationContext =
                this.newDatabaseCreationContext( namedDatabaseId, this.globalModule.getGlobalDependencies(), this.globalModule.getGlobalMonitors() );
