...
public class FileMoveProvider
{
     ...
     * <p>
     * <code>
     * +Parent<br> |+--directoryA<br> |...+--fileA<br> |...+--fileB<br>
     * </code>
     * <p>
     * Suppose we want to move to move <b>Parent/directoryA</b> to <b>Parent/directoryB</b>.<br>
     * <p>
     * <code>
     * File directoryA = new File("Parent/directoryA");<br> Stream<FileMoveAction> fileMoveActions = new FileMoveProvider(pageCache).traverseGenerateMoveActions
     ...
     * <p>
     * <code>
     * File directoryB = new File("Parent/directoryB");<br> fileMoveActions.forEach( action -> action.move( directoryB ) );
     * </code>
     * </p>
     *
