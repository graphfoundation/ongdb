...
public class EnterpriseTestGraphDatabaseFactory extends GraphDatabaseFactory
{
    ...
    public EnterpriseTestGraphDatabaseFactory()
    {
        this( NullLogProvider.getInstance() );
    }

    public EnterpriseTestGraphDatabaseFactory( LogProvider logProvider )
    {
    ...
    public EnterpriseTestGraphDatabaseFactory setFileSystem( FileSystemAbstraction fileSystem )
    {
    ...
    @Override
    public EnterpriseTestGraphDatabaseFactory setMonitors( Monitors monitors )
    {
    ...
    @Override
    public EnterpriseTestGraphDatabaseFactory setUserLogProvider( LogProvider logProvider )
    {
        return (EnterpriseTestGraphDatabaseFactory) super.setUserLogProvider( logProvider );
    }

    public EnterpriseTestGraphDatabaseFactory setInternalLogProvider( LogProvider logProvider )
    {
        getCurrentState().setInternalLogProvider( logProvider );
        return this;
    }

    public EnterpriseTestGraphDatabaseFactory setClock( SystemNanoClock clock )
    {
        getCurrentState().setClock( clock );
        return this;
    }

    public EnterpriseTestGraphDatabaseFactory addKernelExtensions( Iterable<KernelExtensionFactory<?>> newKernelExtensions )
    {
        getCurrentState().addKernelExtensions( newKernelExtensions );
        return this;
    }

    public EnterpriseTestGraphDatabaseFactory addKernelExtension( KernelExtensionFactory<?> newKernelExtension )
    {
        return addKernelExtensions( Collections.singletonList( newKernelExtension ) );
    }

    public EnterpriseTestGraphDatabaseFactory setKernelExtensions( Iterable<KernelExtensionFactory<?>> newKernelExtensions )
    {
        getCurrentState().setKernelExtensions( newKernelExtensions );
        return this;
    }

    public EnterpriseTestGraphDatabaseFactory removeKernelExtensions( Predicate<KernelExtensionFactory<?>> filter )
    {
    ...
    @Override
    public EnterpriseTestGraphDatabaseFactory addURLAccessRule( String protocol, URLAccessRule rule )
    {
        return (EnterpriseTestGraphDatabaseFactory) super.addURLAccessRule( protocol, rule );
    }
    ...
    public static class TestGraphDatabaseFacadeFactory extends GraphDatabaseFacadeFactory
    {
        ...
        {
            this( state, impermanent, DatabaseInfo.ENTERPRISE, EnterpriseEditionModule::new );
        }
