...
class SlottedPrimitiveGroupingAggTable(slots: SlotConfiguration,
                                       ...
                                       state: QueryState) extends AggregationPipe.AggregationTable {
  protected var resultMap: java.util.LinkedHashMap[LongArray, Array[AggregationFunction]] = {
    ???
  }
...
object SlottedPrimitiveGroupingAggTable {
  ...
  case class Factory(val slots: SlotConfiguration,
                     val readGrouping: Array[Int],
                     val writeGrouping: Array[Int],
                     val aggregations: Map[Int, AggregationExpression]) extends AggregationTableFactory {
