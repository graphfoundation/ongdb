...
class TestConfigurationTest extends CypherFunSuite {
  ...
  test("should parse version and planner") {
    TestConfiguration("3.6 planner=cost") should be(TestConfiguration(Versions.V3_6, Planners.Cost, Runtimes.all))
  ...
  test("should parse version and planner and runtime") {
    TestConfiguration("3.6 planner=cost runtime=compiled") should be(TestConfiguration(Versions.V3_6, Planners.Cost, Runtimes.CompiledBytecode))
