...
public final class EnterpriseTestServerBuilders
{
    ...
    /**
     * Create a builder capable of starting an in-process Neo4j instance. This builder will use the standard java temp directory (configured via the
     * 'java.io.tmpdir' system property) as the location for the temporary Neo4j directory.
     */
