...
public class StreamToDiskProvider implements StoreFileStreamProvider
{
    ...
    StreamToDiskProvider( DatabaseLayout databaseLayout, FileSystemAbstraction fs, PageCache pageCache, Monitors monitors )
    {
    ...
    public StoreFileStream acquire( String destination, int requiredAlignment ) throws IOException
    {
        ...
        if ( StoreType.canBeManagedByPageCache( destination ) )
        {
