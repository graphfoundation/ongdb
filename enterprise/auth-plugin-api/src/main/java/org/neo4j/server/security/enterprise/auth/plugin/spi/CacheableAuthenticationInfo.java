...
public interface CacheableAuthenticationInfo extends AuthenticationInfo
{
     ...
     *
     * @param principal   a principal that uniquely identifies the authenticated subject within this authentication provider
    ...
    /**
     * Should return a principal that uniquely identifies the authenticated subject within this authentication provider. This will be used as the cache key, and
     * needs to be matcheable against a principal within the auth token map.
     *
