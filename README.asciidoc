...
Neo4j Enterprise consists of modules from Neo4j Community Edition and modules licensed under AGPLv3 in this repository, and other closed source components not present in this repository.
